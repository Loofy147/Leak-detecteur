// transaction_analysis.test.js

import { detectRecurringCharges, analyzeWithAI } from './transaction_helpers';
...
describe('analyzeWithAI', () => {
  ...
  it('should correctly parse a valid JSON response from the AI', async () => {
    ...
    mockAnthropic.messages.create.mockResolvedValue(aiResponse);
